...
// import SplashScreen from './components/SplashScreen'; // Component no longer used
...
const TryDemo = lazy(() => import('./features/TryDemo'));
...
function App() {
  ...
  // Splash screen removed as per request
