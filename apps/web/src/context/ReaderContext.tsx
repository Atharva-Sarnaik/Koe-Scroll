        ...
        if (libraryMatch) {
            ...
            if (libraryMatch.manga && libraryMatch.manga.chapters && libraryMatch.manga.chapters.length > 0) {
                ...
                if (libraryMatch.chapter.pages.length > 0) {
                    ...
                    // Add saved progress within the chapter to the global index
                    const savedProgress = libraryMatch.chapter.progress || 0;
                    const targetIndex = (globalIndex >= 0 ? globalIndex : 0) + savedProgress;

                    // Simple bounds check
                    setCurrentPageIndex(Math.min(targetIndex, allPages.length - 1));
                } else {
