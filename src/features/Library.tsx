...
import { Search, Mic, Activity, Play, Clock, BarChart3, Database, ChevronDown, ChevronUp, Edit2, Check, X, Trash2 } from 'lucide-react';
import { Link } from 'react-router-dom';
import { useLibrary } from '../context/LibraryContext';

const Library: React.FC = () => {
    const { library, updateMangaMetadata, removeFromLibrary } = useLibrary();
                        ...
                        <div key={item.id} className="glass-panel card-hover" style={{
                            ...
                            >
                                ...
                                <div style={{ display: 'flex', flexDirection: 'column', alignItems: 'flex-end', gap: '12px' }}>
                                    ...
                                    {deletingId === item.id ? (
                                        <div style={{ display: 'flex', alignItems: 'center', gap: '8px' }}>
                                            <span style={{ fontSize: '0.85rem', color: 'var(--color-text-secondary)' }}>Delete?</span>
                                            <button
